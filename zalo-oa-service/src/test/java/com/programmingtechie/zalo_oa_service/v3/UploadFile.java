...
public class UploadFile {
    ...
    public static void main(String[] args) throws APIException {
        ...
        JsonObject excuteRequest = client.excuteRequest(
                "https://dev-openapi.zalo.me/v2.0/oa/upload/file", "POST", null, null, headers, files);
