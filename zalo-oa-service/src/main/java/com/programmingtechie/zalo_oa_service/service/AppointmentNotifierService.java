...
public class AppointmentNotifierService {
        ...
        try {
            ...
            JsonObject element3 = createJsonElement(
                    ...
                    Map.of(
                            ...
                            "left",
                            "content",
                            "Xin chào! Lịch hẹn khám bệnh của bạn đã được đặt thành công! Dưới đây là thông tin:"));
            ...
            JsonObject button2 = createButton(
                    "oa.open.url", "Thanh toán phí khám bệnh", IconURLAddress.ATM_CARD.getUrl(), payloadButton2);
    ...
    public Void confirmAppointment(AppointmentInfo info) throws APIException {
        try {
            ...
            JsonObject element1 = createJsonElement("banner", Map.of("image_url", IconURLAddress.BANNER.getUrl()));
            JsonObject element2 = createJsonElement(
                    "header", Map.of("align", "center", "content", "✔\uFE0F LỊCH HẸN ĐÃ ĐƯỢC XÁC NHẬN"));
            JsonObject element3 = createJsonElement(
                    "text",
                    Map.of(
                            "align",
        ...
        try {
            ...
            JsonObject element3 = createJsonElement(
                    ...
                    Map.of(
                            ...
                            "left",
                            "content",
                            "Xin chào! Ngày mai bạn có lịch hẹn khám! Đừng quên sắp xếp thời gian để đến đúng giờ nhé. Dưới đây là thông tin chi tiết:"));
    ...
    public Void sendThankYouMessage(AppointmentInfo info) throws APIException {
        try {
            ...
            JsonObject element1 = createJsonElement("banner", Map.of("image_url", IconURLAddress.BANNER.getUrl()));
            JsonObject element2 = createJsonElement(
                    "header", Map.of("align", "center", "content", "\uD83D\uDCE9 CẢM ƠN BẠN ĐÃ ĐẾN KHÁM HÔM NAY!"));
            JsonObject element3 = createJsonElement(
                    "text",
                    Map.of(
                            "align",
