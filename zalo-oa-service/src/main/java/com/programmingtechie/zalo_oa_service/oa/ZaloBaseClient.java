...
public class ZaloBaseClient {
    ...
    protected String sendHttpGetRequest(String enpointUrl, Map<String, String> params, Map<String, String> header)
            throws APIException {
    ...
    protected String sendHttpPostRequest(
            String enpointUrl, Map<String, String> params, JsonObject data, Map<String, String> header)
            throws APIException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            try {
    ...
    protected String sendHttpUploadRequest(
            String enpointUrl, File file, Map<String, String> params, Map<String, String> header) throws APIException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            try {
                CloseableHttpClient httpClient = HttpClients.createDefault();
    ...
    protected String sendHttpUploadRequest(
            String enpointUrl, Map<String, File> files, Map<String, String> params, Map<String, String> header)
            throws APIException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        try {
            try {
                ...
                for (String key : files.keySet()) {
                    ...
                    if (value != null) {
                        Mulbuilder.addBinaryBody(
                                key, new FileInputStream(value), ContentType.MULTIPART_FORM_DATA, value.getName());
                    }
                }
    ...
    protected String sendHttpPostWithUrlencodedRequest(
            String enpointUrl, Map<String, String> params, Map<String, String> header, Map<String, String> body)
            throws APIException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
